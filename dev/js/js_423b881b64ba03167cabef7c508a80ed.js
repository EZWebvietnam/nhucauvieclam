...
/*var fbcheck = null;
fbcheck = new Image();
fbcheck.src ='http://www.facebook.com/rsrc.php/v1/ys/r/MGFEYISCL9r.png';*/
...
jQuery(window).load(function(){
  ...
  /*jQuery("img").lazyload({
		placeholder:"http://ntuts.com/themes/vannyneo3/images/box.gif",
		effect:"fadeIn",
		threshhold:200
	});
*/
	...
	if(fbcheck.width>0){
		...
		$(".fbliframe, .onfb, .fblteaster").remove();
	}
*/
