                                ...
                                <tr>
                                    <td class="W50"><?php
                                                    if (is_file($_SERVER['DOCUMENT_ROOT'] . ROT_DIR . 'file/' . $job['u_img'])) {
                                                        ?>
                                                        <img src="<?php echo base_url(); ?>file/<?php echo $job['u_img']; ?>" width="45" alt="<?php echo $job['e_title']; ?>">
                                                    <?php } else { ?> 
                                                        <img src="<?php echo base_url(); ?>template/home/img/default.gif" width="45" alt="<?php echo $job['e_title']; ?>">
                                                    <?php } ?></td>
