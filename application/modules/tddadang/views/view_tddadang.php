                    ...
                    <tr style="">
                        ...
                        <td class="ntd_tb-row-W">
                            <div class="borderBot padTop5">
                                <a href="<?php echo base_url(); ?>tin-tuyen-dung/<?php echo $tddadang['e_id']; ?>-<?php echo mb_strtolower(url_title(removesign($tddadang['e_title']))) ?>" target="_blank" title="">Xem</a> | <a onclick="return confirm('Bạn có chắc muốn xóa hồ sơ không ?')" href='<?php echo base_url(); ?>xoa-tin-td/<?php echo $tddadang['e_id']; ?>/<?php echo mb_strtolower(url_title(removesign($tddadang['e_title']))) ?>' title="Xoá tạm hồ sơ">Xóa</a>
                            </div>
                            <div class="borderBot padTop5">
