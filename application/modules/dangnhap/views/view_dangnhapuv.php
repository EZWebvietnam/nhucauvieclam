...
<div id="content-detail">
    ...
    <div class="Content">
        ...
        <div id="login-image">
            <img src="/img/login_small.png?1379046575" alt="Ðang nh?p">        </div>
        ...
        <div id="login-panel">
            <form  enctype="multipart/form-data" id="SeekerNguoitimviecDangnhapForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>            <table class="TableForm">
                ...
                <tr>
                    <th></th>
                    <td>
                        <a href="/thanhvien/nguoitimviec_quenmatkhau">Quên m?t kh?u</a>
                        &nbsp;|&nbsp;
                        <a href="/thanhvien/nguoitimviec_dangky">Ðang ký</a>
                    </td>
                </tr>
                <tr>
                    <th></th>
