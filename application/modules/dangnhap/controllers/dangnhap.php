<?php class Dangnhap extends CI_Controller
{
    ...
    public function login_uv()
    {
        ...
        $this->data['login_by_username'] = ($this->config->item('login_by_username',
            'tank_auth') and $this->config->item('use_username', 'tank_auth'));
        $this->data['login_by_email'] = $this->config->item('login_by_email',
            'tank_auth');
    ...
    function _show_message($message)
    {
        ...
        if ($this->session->userdata('session_link')) {
            redirect($this->session->userdata('session_link'));
        } else {
            redirect('/trang-chu');
        }
    }
