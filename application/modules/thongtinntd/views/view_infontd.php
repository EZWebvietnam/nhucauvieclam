<div id="user-menu">
    ...
    <div class="GridInfo">
        <div class="Content">
            ...
            <ul class="UserMenu">
                <li>
                    <a href="<?php echo base_url(); ?>quanly-tuyendung/<?php echo $info_list[0]['u_id']; ?>">Quản lý tuyển dụng</a>
                </li>
                <li class="Separator">
                    |
                </li>
                <li>
                    <a href="<?php echo base_url(); ?>tintd-dadang/<?php echo $info_list[0]['u_id']; ?>">Tin TD đã đăng</a>
                </li>
                <li class="Separator">
                    |
                </li>
                <li>
                    <a href="<?php echo base_url(); ?>tao-tintuyendung/<?php echo $info_list[0]['u_id']; ?>">Taọ tin TD mới</a>
                </li>
                <li class="Separator">
                    |
                </li>
                <li>
                    <a href="<?php echo base_url(); ?>thongtin-ntd/<?php echo $info_list[0]['u_id']; ?>">Thông tin NTD</a>
                </li>
                <li class="Separator">
                    |
                </li>
                <li>
                    <a href="<?php echo base_url(); ?>quanly-hoso-ungvien/<?php echo $info_list[0]['u_id']; ?>">Quản lý hồ sơ ứng viên</a>
                </li>
                <li class="Separator">
                    |
                </li>
