            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <a class="btn btn-success" href="<?php echo base_url();?>admin/adminworker/view/<?php echo $member['u_id']?>">
                            ...
                            <a class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa ?');" href="<?php echo base_url();?>admin/adminworker/delete/<?php echo $member['u_id']?>">
                                <i class="icon-trash icon-white"></i> 
                                Xóa
                            </a>
                            <?php 
                            if($member['u_status']==0)
                             {?> <a class="btn btn-primary" href="<?php echo base_url();?>admin/adminworker/ban/<?php echo $member['u_id']?>">
