            ...
            <div class="marBot7">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td class="tb-row-W" align="center"><?php echo $tddaluu_detail[0]['e_dateActive']; ?></td>
                        <td class="tb-row-W" align="center"><?php echo $tddaluu_detail[0]['e_lastDate']; ?></td>
                        <td class="tb-row-W" align="center"><?php echo $tddaluu_detail[0]['e_visits']; ?></td>
                        <td class="tb-row-W" align="center"><?php echo $tddaluu_detail[0]['e_datesave']; ?></td>
                        <td class="tb-row-W">
