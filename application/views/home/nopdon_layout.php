                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="1">
                                                <tbody><tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" class="tbUser-row">Nhân viên tư vấn bảo hiểm, làm việc tại ngân hàng</td>
                                                        <td valign="top" class="tbUser-row">Công ty CP Adecco VN</td>
                                                        <td valign="top" class="tbUser-row">An Nguyen</td>
                                                    </tr>
                                                </tbody></table>
                                            <table>	
                                                <tbody><tr>
                                            ...
                                            <div class="mar-T-20">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">                    	
                                                    <tbody><tr>
                                                            ...
                                                            <td class="tbUser-row" style="font-weight:bold;">Đoàn Quang Thắng</td>                            	                    	
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tbUser-row">
                                                                ...
                                                                <select class="dropbox" name="c_cv" id="c_cv">
                                                                    ...
                                                                    <option value="137108">Hồ sơ ứng tuyển vị trí nhân viên lập trình web</option>
                                                                </select>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="tbUser-row" align="right">
                                                                <b>Mã bảo mật:</b>
                                                            </td>
                                                            <td class="tbUser-row">
                                                                <div id="div_ma_xac_minh"><img src="/security_image.php?time=1386400695" id="security_image" name="security_image" alt="" width="65" height="31"></div>
                                                            </td>                            	                    	
                                                        </tr>  
                                                        <tr>
                                                            <td valign="top" class="tbUser-row" align="right">
                                                                <b>Nhập mã bảo mật (<span class="textRed">*</span>):</b>
                                                            </td>
                                                            <td class="tbUser-row">
                                                                <input type="text" class="textbox" name="txt_ma_xac_minh" id="txt_ma_xac_minh" onkeydown="if (event.keyCode == 13 || event.keyCode == '13') {
                                                            return(false);
                                                        }">
                                                                <div id="err_c_ma_xac_minh" class="textRed11"></div>
                                                            </td>
                                                        </tr>
                                                    </tbody></table>
                                            </div>
