<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://ogp.me/ns/fb#">
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            <title>Tuyển dụng nhanh, nhà tuyển dụng</title>
                                        ...
                                        <div id="content-detail">
                                            ...
                                            <div id="content-left">
                                                ...
                                                <div class="Grid">
                                                    <div class="TopLeft">
                                                        <div class="TopRight">
                                                            <h2 class="Headline"> Tìm việc làm tuyển dụng theo Ngành nghề </h2>
                                                        </div>
                                                    </div>
                                                    <div class="BodyLeft">
                                                        <div class="BodyRight">
    ...
    <?php } ?>
                                                ...
                                                <div class="Grid">
                                                    <div class="TopLeft">
                                                        <div class="TopRight">
                                                            <h2 class="Headline"> Tìm hồ sơ Người tìm việc theo Tỉnh/Thành phố </h2>
                                                        </div>
                                                    </div>
                                                    <div class="BodyLeft">
                                                        <div class="BodyRight">
                                                            ...
                                                            <table class="TableList">
                                                                <tbody>
                                                                    ...
                                                                    <?php
                                                                    $i = 1;
                                                                    foreach ($load_city as $city_cate) {
    ...
    <?php } ?>
                                                                            <td width="33%">
                                                                                <ul>
                                                                                    <li>
                                                                                        <a href="<?php echo base_url(); ?>chitietnghe/Tuyendungnhanh/tuyendungnhanh_post/<?php echo $city_cate['n_id'] ?>"  title="<?php echo $city_cate['m_name'] ?>" target="_blank"> <?php echo $job_cate['n_name'] ?> </a>
                                                                                    </li>
                                                                                </ul>
                                                                            </td>
                                                                            <?php
                                            ...
                                            <div id="content-right">
                                                ...
                                                <div class="GridSub">
                                                    <div class="TopLeft">
                                                        <div class="TopRight">
                                                            <h2 class="Headline">Tuyển dụng nhanh</h2>
                                                        </div>
                                                    </div>
                                                    <div class="BodyLeft">
                                                        <div class="BodyRight">
                                                            <form action="/timungvien/timkiem" enctype="multipart/form-data" id="ResumeSearchResumeFormForm" method="get" accept-charset="utf-8">
                                                                <table class="TableSearchForm">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input name="keywords" class="W237" type="text" id="ResumeKeywords">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Ngành nghề</th>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekerbranch" class="W245" id="ResumeSeekerbranch">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekerworkplace" class="W245" id="ResumeSeekerworkplace">
                                                                                    <option value="">Bất kỳ</option>
                                                                                    <option value="1">TP.Hồ Chí Minh</option>
                                                                                    <option value="2">Hà Nội</option>
                                                                                    <option value="3">An Giang</option>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekergender" class="W245" id="ResumeSeekergender">
                                                                                    <option value="">Bất kỳ</option>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekerfunction" class="W245" id="ResumeSeekerfunction">
                                                                                    <option value="">Bất kỳ</option>
                                                                                    <option value="0">Nhân viên</option>
                                                                                    <option value="1">Kỹ sư</option>
                                                                                    <option value="2">Phó phòng</option>
                                                                                    <option value="3">Trưởng phòng</option>
                                                                                    <option value="4">Cố vấn/Giám sát</option>
                                                                                    <option value="5">Phó giám đốc/Phó tổng giám đốc</option>
                                                                                    <option value="6">Giám đốc/Tổng giám đốc</option>
                                                                                </select></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>Trình độ</th>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekerlevel" class="W245" id="ResumeSeekerlevel">
                                                                                    <option value="">Bất kỳ</option>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekerexperience" class="W245" id="ResumeSeekerexperience">
                                                                                    <option value="">Bất kỳ</option>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="language" class="W245" id="ResumeLanguage">
                                                                                    <option value="">Bất kỳ</option>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <select name="seekersalaryunit" class="W80" id="ResumeSeekersalaryunit">
                                                                                    <option value="">Bất kỳ</option>
                                                                                    <option value="Y">VND</option>
                                                                                    <option value="N">USD</option>
                                                                                </select>
                                                                                <select name="seekersalary_vnd" id="resume-salary-vnd" class="W120" disabled="disabled">
                                                                                    <option value="">Bất kỳ</option>
                                                                                ...
                                                                                <select name="seekersalary_usd" id="resume-salary-usd" class="W120" style="display: none;" disabled="disabled">
                                                                                    <option value="">Bất kỳ</option>
                                                                        ...
                                                                        <tr>
                                                                            <th>
                                                                                <button type="submit" onclick="javascript:return submitResumeSearch();">
                                                                                    <span class="submit">Tìm kiếm</span>
                                                                                </button></th>
                                                                        </tr>
                                                                    </tbody>
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    positions[0] = 'nhan-vien';
                                                    positions[1] = 'ky-su';
                                                    positions[2] = 'pho-phong';
                                                    positions[3] = 'truong-phong';
                                                    positions[4] = 'co-van-giam-sat';
                                                    positions[5] = 'pho-giam-doc-pho-tong-giam-doc';
                                                    positions[6] = 'giam-doc-tong-giam-doc';
                                                    ...
                                                    languages[10] = 'tieng-anh';
                                                    languages[11] = 'tieng-phap';
                                                    languages[12] = 'tieng-trung';
                                                    languages[13] = 'tieng-nhat';
                                                    languages[14] = 'tieng-han';
                                                    languages[15] = 'tieng-nga';
                                                    languages[16] = 'tieng-duc';
                                                    languages[17] = 'tieng-y';
                                                    languages[18] = 'tieng-a-rap';
                                                    languages[19] = 'ngon-ngu-khac';
                                                    ...
                                                    function submitResumeSearch() {
                                                        var url_root = '/timungvien/timkiem';
                                                        var url = '';

                                                        if ($.trim($('#ResumeKeywords').val()) != '') {
                                                            url += '/tukhoa:' + $.trim($('#ResumeKeywords').val());
                                                        }

                                                        if ($('#ResumeSeekerbranch').val() != '') {
                                                            url += '/nganhnghe:' + fields[$('#ResumeSeekerbranch').val()];
                                                        }

                                                        if ($('#ResumeSeekerworkplace').val() != '') {
                                                            url += '/tinhthanhpho:' + provinces[$('#ResumeSeekerworkplace').val()];
                                                        }

                                                        if ($('#ResumeSeekergender').val() != '') {
                                                            url += '/gioitinh:' + genders[$('#ResumeSeekergender').val()];
                                                        }

                                                        if ($('#ResumeSeekerfunction').val() != '') {
                                                            url += '/vitri:' + positions[$('#ResumeSeekerfunction').val()];
                                                        }

                                                        if ($('#ResumeSeekerlevel').val() != '') {
                                                            url += '/trinhdo:' + levels[$('#ResumeSeekerlevel').val()];
                                                        }

                                                        if ($('#ResumeSeekerexperience').val() != '') {
                                                            url += '/kinhnghiem:' + experiences[$('#ResumeSeekerexperience').val()];
                                                        }

                                                        if ($('#ResumeLanguage').val() != '') {
                                                            url += '/ngoaingu:' + languages[$('#ResumeLanguage').val()];
                                                        }

                                                        if ($('#ResumeSeekersalaryunit').val() != '') {
                                                            if ($('#ResumeSeekersalaryunit').val() == 'Y') {
                                                                if ($('#resume-salary-vnd').val() != '') {
                                                                    url += '/mucluong:' + salary_vnd[$('#resume-salary-vnd').val()];
                                                                }
                                                            } else {
                                                                if ($('#resume-salary-usd').val() != '') {
                                                                    url += '/mucluong:' + salary_usd[$('#resume-salary-usd').val()];
                                                                }
                                                            }
                                                        }
                                                    ...
                                                    $(document).ready(function() {
                                                        $('#ResumeSeekersalaryunit').change(function() {
                                                            if ($(this).val() == 'Y') {
                                                                $('#resume-salary-vnd').show();
                                                                $('#resume-salary-usd').hide();
                                                                $('#resume-salary-vnd').val('');
                                                                $('#resume-salary-usd').val('');
                                                                $('#resume-salary-vnd').removeAttr('disabled');
                                                                $('#resume-salary-usd').removeAttr('disabled');
                                                            }

                                                            if ($(this).val() == 'N') {
                                                                $('#resume-salary-vnd').hide();
                                                                $('#resume-salary-usd').show();
                                                                $('#resume-salary-vnd').val('');
                                                                $('#resume-salary-usd').val('');
                                                                $('#resume-salary-vnd').removeAttr('disabled');
                                                                $('#resume-salary-usd').removeAttr('disabled');
                                                            ...
                                                            if ($(this).val() == '') {
                                                                ...
                                                                $('#resume-salary-vnd').val('');
                                                                $('#resume-salary-usd').val('');
                                                                $('#resume-salary-vnd').attr('disabled', 'disabled');
                                                                $('#resume-salary-usd').attr('disabled', 'disabled');
                                                            }
                                                        });
                                                    });
                                                </script>
                        ...
                        <div id="fb-root" class=" fb_reset">
                            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                                <div>
                                    <iframe name="fb_xdm_frame_http" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_http" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tab-index="-1" src="http://static.ak.facebook.com/connect/xd_arbiter.php?version=28#channel=f13a32240&amp;channel_path=%2Ftimungvien%3Ffb_xd_fragment%23xd_sig%3Df1e6bd006%26&amp;origin=http%3A%2F%2Fwww.timviecnhanh.com" style="border: none;"></iframe><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tab-index="-1" src="https://s-static.ak.facebook.com/connect/xd_arbiter.php?version=28#channel=f13a32240&amp;channel_path=%2Ftimungvien%3Ffb_xd_fragment%23xd_sig%3Df1e6bd006%26&amp;origin=http%3A%2F%2Fwww.timviecnhanh.com" style="border: none;"></iframe>
                                </div>
                            </div>
                            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                                <div></div>
                        ...
                        </div><iframe name="oauth2relay599573058" id="oauth2relay599573058" src="https://accounts.google.com/o/oauth2/postmessageRelay?parent=http%3A%2F%2Fwww.timviecnhanh.com#rpctoken=508355114&amp;forcesecure=1" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe>
                    </body>
                    </html>