                                                        ...
                                                        <div class="jcarousel-container jcarousel-container-horizontal" style="position: relative; display: block;">
                                                            <div class="jcarousel-clip jcarousel-clip-horizontal" style="position: relative;">
                                                                <ul id="mycarousel" class="jcarousel-list jcarousel-list-horizontal" style="overflow: hidden; position: relative; top: 0px; margin: 0px; padding: 0px; left: -7660.55508px; width: 12220px;">
                                                                    ...
                                                                    </li><li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-91 jcarousel-item-91-horizontal" jcarouselindex="91" style="float: left; list-style: none;">
                                                                        <a href="" target="_blank"><img src="<?php echo base_url(); ?>template/home/img/imployees7.jpg" alt="" title="et"></a>
                                                                    </li><li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-92 jcarousel-item-92-horizontal" jcarouselindex="92" style="float: left; list-style: none;">
                                                                        <a href="" target="_blank"><img src="<?php echo base_url(); ?>template/home/img/imployees1.jpg" alt="" title="test"></a>
                                                                    </li><li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-93 jcarousel-item-93-horizontal" jcarouselindex="93" style="float: left; list-style: none;">
                                                                        <a href="" target="_blank"><img src="<?php echo base_url(); ?>template/home/img/imployees2.jpg" alt="" title="Quang cao"></a>
                                                                    </li><li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-94 jcarousel-item-94-horizontal" jcarouselindex="94" style="float: left; list-style: none;">
                                                                        <a href="" target="_blank"><img src="<?php echo base_url(); ?>template/home/img/imployees3.jpg" alt="" title="Noi that"></a>
                                                                    </li><li class="jcarousel-item jcarousel-item-horizontal jcarousel-item-95 jcarousel-item-95-horizontal" jcarouselindex="95" style="float: left; list-style: none;">
                                                                        <a href="" target="_blank"><img src="<?php echo base_url(); ?>template/home/img/imployees4.jpg" alt="" title="et"></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                        ...
                                        <div id="content-detail">
                                            ...
                                            <div id="content-left">
                                                ...
                                                <div class="Grid">
                                                    <div class="TopLeft">
                                                        <div class="TopRight">
                                                            <h2 class="Headline"> Tìm việc làm tuyển dụng theo Tỉnh/Thành phố </h2>
                                                        </div>
                                                    </div>
                                                    <div class="BodyLeft">
                                                        <div class="BodyRight">
    ...
    <?php } ?>
                                            ...
                                            <div id="content-right">
                                                ...
                                                <div class="GridSub">
                                                    <div class="TopLeft">
                                                        <div class="TopRight">
                                                            <h2 class="Headline">Tìm việc nhanh</h2>
                                                        </div>
                                                    </div>
                                                    <div class="BodyLeft">
                                                        <div class="BodyRight">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <select name="jobsalary_vnd" id="job-salary-vnd" class="W120" disabled="disabled">
                                                                                    <option value="">Bất kỳ</option>
                                                                                ...
                                                                                <select name="jobsalary_usd" id="job-salary-usd" class="W120" style="display: none;" disabled="disabled">
                                                                                    <option value="">Bất kỳ</option>
                        ...
                        </div><iframe name="oauth2relay264669459" id="oauth2relay264669459" src="https://accounts.google.com/o/oauth2/postmessageRelay?parent=http%3A%2F%2Fwww.timviecnhanh.com#rpctoken=475591707&amp;forcesecure=1" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe>

                        <div id="fb-root" class=" fb_reset">
                            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                                <div>
                                    <iframe name="fb_xdm_frame_http" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_http" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tab-index="-1" src="http://static.ak.facebook.com/connect/xd_arbiter.php?version=28#channel=f5c5e9d14&amp;channel_path=%2Fvieclam%3Ffb_xd_fragment%23xd_sig%3Df32b323edc%26&amp;origin=http%3A%2F%2Fwww.timviecnhanh.com" style="border: none;"></iframe><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tab-index="-1" src="https://s-static.ak.facebook.com/connect/xd_arbiter.php?version=28#channel=f5c5e9d14&amp;channel_path=%2Fvieclam%3Ffb_xd_fragment%23xd_sig%3Df32b323edc%26&amp;origin=http%3A%2F%2Fwww.timviecnhanh.com" style="border: none;"></iframe>
                                </div>
                            </div>
                            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                                <div></div>
