                                                        ...
                                                        <div id="content-left">
                                                            ...
                                                            <div class="Grid">
                                                                <div class="TopLeft">
                                                                    <div class="TopRight">
                                                                        <h2 class="Headline">
                                                                            Tìm việc làm tuyển dụng theo Ngành nghề            </h2>
                                                                    </div>
                                                                </div>
                                                                <div class="BodyLeft">
                                                                    <div class="BodyRight">
    ...
    <?php } ?>
                                                            ...
                                                            <div class="Grid">
                                                                <div class="TopLeft">
                                                                    <div class="TopRight">
                                                                        <h2 class="Headline">
                                                                            Tìm việc làm tuyển dụng theo Tỉnh/Thành phố            </h2>
                                                                    </div>
                                                                </div>
                                                                <div class="BodyLeft">
                                                                    <div class="BodyRight">
...
?>
                        ...
                        <div id="fb-root" class=" fb_reset">
                            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                                <div>
                                    <iframe name="fb_xdm_frame_http" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_http" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tab-index="-1" src="http://static.ak.facebook.com/connect/xd_arbiter.php?version=28#channel=f1ebdd25f8&amp;channel_path=%2Fnhatuyendung%2Ftaikhoan%3Ffb_xd_fragment%23xd_sig%3Df1bd5455ec%26&amp;origin=http%3A%2F%2Fwww.timviecnhanh.com" style="border: none;"></iframe><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tab-index="-1" src="https://s-static.ak.facebook.com/connect/xd_arbiter.php?version=28#channel=f1ebdd25f8&amp;channel_path=%2Fnhatuyendung%2Ftaikhoan%3Ffb_xd_fragment%23xd_sig%3Df1bd5455ec%26&amp;origin=http%3A%2F%2Fwww.timviecnhanh.com" style="border: none;"></iframe>
                                </div>
                            </div>
                            <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                                <div></div>
                        ...
                        </div><iframe name="oauth2relay583766969" id="oauth2relay583766969" src="https://accounts.google.com/o/oauth2/postmessageRelay?parent=http%3A%2F%2Fwww.timviecnhanh.com#rpctoken=259258227&amp;forcesecure=1" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe>
                    </body>
                    </html>