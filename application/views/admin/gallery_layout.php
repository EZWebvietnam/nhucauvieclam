...
<html lang="en">
    <head>
        ...
        <!-- The fav icon -->
        <link rel="shortcut icon" href="<?php echo base_url(); ?>template/admin_ninhbinhcoop/css/img/favicon.ico">
    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/bus"><i class="icon-plane"></i><span class="hidden-tablet">Tuyến xe</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/park"><i class="icon-th-large"></i><span class="hidden-tablet">Bến xe</span></a></li>
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/workshop"><i class="icon-asterisk"></i><span class="hidden-tablet">Xưởng sửa chữa</span></a></li>
                        </ul>
            ...
            <footer>
                <p class="pull-left">&copy; <a href="http://ezwebvietnam.com" target="_blank">EZWEBVIETNAM</a> 2013</p>
                <p class="pull-right">Powered by: <a href="http://ezwebvietnam.com">EZWEBVIETNAM</a></p>
            </footer>
