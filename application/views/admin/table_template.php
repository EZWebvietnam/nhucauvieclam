...
<head>
	...
	-->
	<meta charset="utf-8">
	<title>ADMINISTRATOR NHUCAUVIECLAM</title>
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href=""> <img alt="" src="<?php echo base_url();?>template/admin_ninhbinhcoop/img/logo20.png" /> <span>NHUCAUVIECLAM</span></a>
				...
				<div class="btn-group pull-right" >
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i><span class="hidden-phone"> <?php echo $this->session->userdata['u_username']?></span>
						<span class="caret"></span>
					</a>
	...
	<!-- topbar ends -->
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url(); ?>admin/adminuser/listuser"><i class="icon-user"></i><span class="hidden-tablet">Thành viên</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/adminbusiness"><i class="icon-info-sign"></i><span class="hidden-tablet">Doanh nghiệp</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/admincv"><i class="icon-plane"></i><span class="hidden-tablet">Hồ sơ ứng viên</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/adminworker"><i class="icon-th-large"></i><span class="hidden-tablet">Ứng viên</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>admin/adminjob"><i class="icon-th-list"></i><span class="hidden-tablet">Tin tuyển dụng</span></a></li>
		...
		<footer>
			<p class="pull-left">&copy; <a href="http://nhucauvieclam.net" target="_blank">NHU CẦU VIỆC LÀM</a> 2013</p>
