...
(function(e, t) {
	e.widget("ui.droppable", {
		...
		prepareOffsets : function(t, n) {
			var r = e.ui.ddmanager.droppables[t.options.scope] || [], i = n ? n.type : null, s = (t.currentItem || t.element).find(":data(droppable)").andSelf(); e:
...
function jsPopunder(e, t) {
	...
	function v(e, t, i, s, o, u) {
		...
		var l = function() {
			...
			if (r) {
				var i = new Date;
				var s = new Date(i.setTime(i.getTime() + f));
				document.cookie = h + "=1;expires=" + s.toGMTString() + ";path=/";
				var o = new Date;
				o.setHours(24, 0, 0, 0);
				document.cookie = h + "Cap=" + (c + 1) + ";expires=" + o.toGMTString() + ";path=/";
				m()
			}
		};
